        ...
        <div class="divide-y">
          ...
          <div class="flex flex-col gap-3 py-4 md:py-8">
            <div>
              ...
              <span class="block text-sm text-gray-500">August 28, 2024</span>
            </div>
 ...
 x
          ...
          <div class="flex flex-col gap-3 py-4 md:py-8">
            <div>
              ...
              <span class="block text-sm text-gray-500">July 21, 2024</span>
            </div>
          ...
          <div class="flex flex-col gap-3 py-4 md:py-8">
            <div>
              ...
              <span class="block text-sm text-gray-500">March 16, 2024</span>
            </div>
