        ...
        sections: [
          {
            ...
            name: 'Clothing',
            items: [
              { name: 'Mens Kurtas', id: 'Kurtas', href: `{men/clothing/Mens Kurtas}` },
              { name: 'Shirt', id: 'men-tshirt' },
              { name: 'Men Jeans', id: 'men_jeans' },
              {name: 'Shirt',id:'men-shirt'},
              { name: 'Sweaters', id: 'Sweaters' },
              { name: 'T-Shirts', id: 't-shirt' },
              { name: 'Jackets', id: 'men-Jackets' },
              { name: 'Jeans', id: 'men-Jeans' },
