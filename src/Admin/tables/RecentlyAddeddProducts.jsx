      ...
      <Table sx={{ minWidth: 800 }} aria-label='table in dashboard'>
        <TableHead>
          <TableRow>
           ...
           <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Category</TableCell>
            <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Price</TableCell>
             <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Quantity</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
