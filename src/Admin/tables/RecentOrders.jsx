        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Price</TableCell>
             <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Order Id</TableCell>
             <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Status</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
