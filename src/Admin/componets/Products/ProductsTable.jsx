      ...
      <Card className="mt-2">
        ...
        <TableContainer>
          <Table sx={{ minWidth: 800 }} aria-label="table in dashboard">
            <TableHead>
              <TableRow>
                <TableCell sx={{ textAlign: "center", fontSize:"18px",fontWeight:"bold" }} >Image</TableCell>
                <TableCell sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Title</TableCell>
                <TableCell sx={{ textAlign: "center", fontSize:"18px",fontWeight:"bold" }} >Category</TableCell>
                <TableCell sx={{ textAlign: "center", fontSize:"18px",fontWeight:"bold" }} >Price</TableCell>
