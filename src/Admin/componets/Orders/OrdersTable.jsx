      ...
      <Card className="mt-2">
        ...
        <TableContainer>
          <Table sx={{ minWidth: 800 }} aria-label="table in dashboard">
            <TableHead>
              <TableRow>
                <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Image</TableCell>
                <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Title</TableCell>

                <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Price</TableCell>
                <TableCell  sx={{ textAlign: "left", fontSize:"18px",fontWeight:"bold" }} >Id</TableCell>
                <TableCell sx={{ textAlign: "center" ,fontSize:"18px",fontWeight:"bold"}}>Status</TableCell>
                <TableCell sx={{ textAlign: "center",fontSize:"18px",fontWeight:"bold" }}>Update</TableCell>
                <TableCell sx={{ textAlign: "center",fontSize:"18px",fontWeight:"bold" }}>Delete</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
